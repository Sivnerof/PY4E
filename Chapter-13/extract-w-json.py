...
# and the other is the actual data you need to process for the assignment.
    ...
    # Actual data: http://py4e-data.dr-chuck.net/comments_1495651.json (Sum ends with 98)
...
# The closest sample code that shows how to parse JSON and 
# extract a list is json2.py. 
# You might also want to look at geoxml.py 

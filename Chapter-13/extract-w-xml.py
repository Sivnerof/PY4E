...
# your testing and the other is the actual data you need to process for the assignment.
    ...
    # Actual data: http://py4e-data.dr-chuck.net/comments_1495650.xml (Sum ends with 77)
...
# Data Format and Approach
    ...
    # But since the nesting of the elements in our data is 
    # different than the data we are parsing in that sample code 
    # you will have to make real changes to the code.

# To make the code a little simpler, 
# you can use an XPath selector string to look through the 
# entire tree of XML for any tag named 'count' with the following line of code:
    # counts = tree.findall('.//count')

# Take a look at the Python ElementTree documentation and 
# look for the supported XPath syntax for details. 
# You could also work from the top of the XML down to 

# Calling a JSON API
    ...
    # somewhat similar to http://www.py4e.com/code3/geojson.py. 
    # The program will prompt for a location, 
    # contact a web service and retrieve JSON for the web service and 
...
# Turn In
    ...
    # Hint: The first seven characters of the place_id are "ChIJC6Y ..."

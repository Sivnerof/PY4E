...
# Data Files
    ...
    # Actual data: http://py4e-data.dr-chuck.net/regex_sum_1495646.txt 
        # (There are 76 values and the sum ends with 837)
...
# Optional: Just for Fun
    ...
    # Here is a a redacted version of two-line version of this program using list comprehension:
...
try:
    fh = open(input("File Name: "))
except:
    quit('Enter file name')

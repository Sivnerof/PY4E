...
# You do not need to export or convert the database - 
# simply upload the .sqlite file that your program creates. 
...
# there is a balance between the number of operations you execute between commits and 

...
# and the other is the actual data you need to process for the assignment.
    ...
    # Actual data: http://py4e-data.dr-chuck.net/comments_1495648.html (Sum ends with 67)
...
# Create list for storing values from span
span_sum = list()

for span in spans:
    # Look at the parts of a tag
    span_sum.append(int(span.contents[0]))
